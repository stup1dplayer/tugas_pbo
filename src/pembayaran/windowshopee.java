 ...
 * @author afkar
 */
public class windowshopee extends javax.swing.JFrame {

    /**
     * Creates new form windowshopee
     */
    public windowshopee() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BAYAR SHOPEEPAY");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Belanjatotal = totalbelanja.getText();
        double  BelanjatotalDouble = Double.parseDouble(Belanjatotal);

        PembayaranBelanja byr = new PembayaranBelanja();
        byr.bayarShopeePay(number, saldoDouble, BelanjatotalDouble);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(windowshopee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
