 ...
 * @author afkar
 */
public class windowcreditcard extends javax.swing.JFrame {

    /**
     * Creates new form windowcreditcard
     */
    public windowcreditcard() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BAYAR CREDIT CARD");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String idNasabah = id.getText();
        int number =Integer. parseInt(idNasabah);
        ...
        byr.BayarCreditCard(number,namaBank ,cn , saldoDouble, totalBelanjaDouble);
        output.setText(namaBank +"\n"+"nomor kartu " +
                cn +"\n"+"pelanggan dengan id "
                + number +"\n"+ byr.credit());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(windowcreditcard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
